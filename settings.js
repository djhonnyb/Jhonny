...
global.owner = [
   ['51910045887', 'Creador 👑', true],
   ['51910045887', 'Owner 🍭', true],
   ['573012482597'],
   ['5493794297363'],
   ['5351524614']
]
...
global.nameqr = '𝄛〘لʜͦᴏͭɴͣɴʏ〙𝄛'
global.namebot = '<|ʲ̲̅ʰ̲̅ᵒ̲̅ⁿ̲̅ⁿ̲̅ʸ̲̅|>'
global.sessions = 'MiniSession'
global.jadi = 'MiniJadiBot'

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.packname = '𝄛〘لʜͦᴏͭɴͣɴʏ〙𝄛'
global.botname = '<|ʲ̲̅ʰ̲̅ᵒ̲̅ⁿ̲̅ⁿ̲̅ʸ̲̅|>'
global.wm = '𝄛〘لʜͦᴏͭɴͣɴʏ〙𝄛'
global.author = 'sᥙᥒᥣіgһ𝗍'
global.dev = '© ⍴᥆ᥕᥱrᥱძ ᑲᥡ sᥙᥒᥣіgһ𝗍 𝗍ᥱᥲm ❀'
global.textbot = 'Ai : Jhonny 🚩'
...
global.yt = 'https://www.youtube.com/@djhonnyb2'
global.tiktok = 'https://tiktok.com/@djhonnyb'
global.correo = 'jhonny.jota88@gmail.com'
