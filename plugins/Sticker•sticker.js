...
else return m.reply(`💫 Url incorrecto!!`)
...
if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: `𝄛〘لʜͦᴏͭɴͣɴʏ〙𝄛 🚩`, body: `✡︎ Sticker By • <|ʲ̲̅ʰ̲̅ᵒ̲̅ⁿ̲̅ⁿ̲̅ʸ̲̅|>`, mediaType: 2, sourceUrl: redes, thumbnail: icons}}}, { quoted: m })
